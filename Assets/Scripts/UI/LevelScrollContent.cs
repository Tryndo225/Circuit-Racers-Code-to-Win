...
public class LevelScrollContent : MonoBehaviour
{
	...
	/// </summary>
	[Tooltip("ScrollRect content container where level preview entries are instantiated and laid out.")]
	...
	/// </summary>
	[Tooltip("Number of level preview items shown per row.")]
	...
	/// </summary>
	[Tooltip("Horizontal gap between preview items, expressed as a ratio of the viewport width.")]
	...
	/// </summary>
	[Tooltip("Vertical gap between preview rows, expressed as a ratio of the viewport width.")]
	...
	/// </summary>
	[Tooltip("Left and right padding, expressed as a ratio of the viewport width.")]
	...
	/// </summary>
	[Tooltip("Top padding above the first preview row, expressed as a ratio of the viewport width.")]
	...
	/// </summary>
	[Tooltip("Bottom padding below the last preview row, expressed as a ratio of the viewport width.")]
	...
	/// </summary>
	[Tooltip("Prefab instantiated once per saved level. It must include a LevelEntry component.")]
